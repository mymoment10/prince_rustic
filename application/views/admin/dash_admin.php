...
<body>
    ...
    <main id="main">
        ...
        <section id="contact" class="contact" style="background-image: url('assets/img/additional-images/bg-quotes.svg'); background-size: cover;">
            <div class="container justify-content-center my-lg-auto my-auto" data-aos="fade-up">

                <div class="section-title">
                    <h2 class="text-black" style="font-family: Dandeleon;">Dashboard Admin</h2>
                    <div class="row" style="font-family: 'Cairo', sans-serif;">
                        <div class="col-lg-6 col-12">
                            <h5 class="text-black mt-lg-4 mt-0">Hello, <?= $this->session->userdata('username') ?></h5>
                        </div>
                        <div class="col-lg-6 col-12">
                            <a href="<?= base_url() ?>Login/logout"><button class="btn-dark btn rounded-3 w-auto text-right text-white mt-lg-3 mt-3">Logout</button></a>
                        </div>
                    </div>
                </div>
        ...
        <section style="background-image: url('assets/img/additional-images/bg-protocol.svg'); background-size: cover;">
            <div class="container" style="font-family: 'Cairo', sans-serif;">
                <!-- Tabs navs -->
                <ul class="nav nav-tabs mb-3 text-white" id="ex1" role="tablist">
                ...
                <div class="tab-content" id="ex1-content">
                    <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded-pill shadow-lg row p-lg-2 p-3 col-12 mx-lg-0 mx-auto">
                            <div class="col-lg-10 col-12 text-center ">
                                <h4 class="text-white text-lg-left mx-lg-0 mx-3 mt-lg-2 mt-1">Daftar Nama Tamu</h4>
                            </div>
                            <div class="col-lg-2 col-12 text-center mt-lg-0 mt-2">
                                <button type="button" class="btn bg-white text-dark rounded-pill mx-lg-0 mx-auto" data-toggle="modal" data-target="#form_nama_tamu"><i class="bi bi-plus"></i> Tambah Tamu</button>
                            </div>

                        </nav>
                        <div class="table-responsive">

                            <table id="table_id" class="table table-bordered table-sm  rounded-lg shadow-lg mt-lg-3 mt-3 text-white">
                                <thead>
                                    <tr>
                                        <th>ID Tamu</th>
                                        <th>Nama Tamu</th>
                    ...
                    <div class="tab-pane fade" id="ex1-tabs-2" role="tabpanel" aria-labelledby="ex1-tab-2">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded-pill shadow-lg row mx-lg-0 mx-auto">
                            <div class=" col-12">
                                <h4 class="text-white mx-lg-0 mx-3 mt-lg-2 mt-1">Kehadiran</h4>
                            </div>

                        </nav>
                        <div class="table-responsive">

                            <table id="table_id" class="table table-bordered text-white rounded-lg shadow-lg mt-lg-3 mt-3">
                                <thead>
                                    <tr>
                                        <th>ID RSVP</th>
                                        <th>Nama Lengkap</th>
